...
REGIONS = [
    ...
    },
    {
        "id": "samjeon_sang",
        "name": "삼전동(상단)",
        "fullName": "송파구 삼전동 상단 민간도심복합개발 — 백제고분로 북측 (석촌호수 방면)",
        "sector": "삼전동",
        # 삼전동 center: 37.5027, 127.0925 / 백제고분로 북측 (37.503~37.510)
        "bbox": {"left": 127.084, "right": 127.099, "top": 37.510, "bottom": 37.503},
        "focus": "investment",
    ...
    },
    {
        ...
        "sector": "삼전동",
        # 64-1번지 도심복합개발구역 중심(37.499, 127.093) / 백제고분로 남측 (37.494~37.503)
        "bbox": {"left": 127.084, "right": 127.099, "top": 37.503, "bottom": 37.494},
        "focus": "investment",
        "realEstateTypes": ["A01", "A04", "A05", "B01", "B02"],
        "typeCodeFilter": ["A05", "B01", "B02"],
    },
